...
class _MyJobsFragmentState extends State<MyJobsFragment> {
  ...
  void initState() {
    ...
    emAndamentoJobs.add(Job("Job4", "", "", []));
    emAndamentoJobs.add(Job("Job4", "", "", []));
    lancadoJobs.add(Job("Job5", "", "", []));
    lancadoJobs.add(Job("Job6", "", "", []));
    finalizadoJobs.add(Job("Job7", "", "", []));
    finalizadoJobs.add(Job("Job9", "", "", []));
    finalizadoJobs.add(Job("Job9", "", "", []));
            ...
            switch (snapshot.connectionState) {
              ...
              default:
                if (snapshot.hasError)
                  ...
                  return new StatefulListView(jobs: lancadoJobs,isLoading: false,);
            }
          },
        ),
        new FutureBuilder<String>(
...
List<Job> lancadoJobs = new List<Job>();
