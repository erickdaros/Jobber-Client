...
class ResponsiveContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var calculatedHeightPercent = percent(height, heightPercent);
    var calculatedWidthPercent;

    if(setwidthModifier){
      calculatedWidthPercent = (calculatedHeightPercent*this.widthModifier);
    }else{
      calculatedWidthPercent = percent(width, widthPercent);
    }
