  ...
  DropDownFormField(
    ...
    builder: (FormFieldState<String> field) {
      ...
      for (var item in items) {
        if (state._searchText.isNotEmpty) {
          if (item.toUpperCase().contains(state._searchText.toUpperCase()))
            itemCounter++;
        } else {
        }
      }
...
//                  autovalidate: true,
                  ...
                  validator: (String newValue) {
                    ...
                    if (items != null) {
                      if (strict &&
                        ...
                        return 'Valor inserido não é válido!';
                    }
                  },
                  onSaved: setter,
                  enabled: enabled,
              ...
              index==0?Container():IconButton(
                ...
                onPressed: (){
                    int index = onGetPosition(keyValue);
                    if(index==0){
          ...
          !state._showdropdown
            ...
            height: itemsVisibleInDropdown *
                (48.0*state._items.length)/3, //limit to default 3 items in dropdownlist view and then remaining scrolls
